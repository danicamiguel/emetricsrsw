...
`stat_sum`: provides summary statistics for all variables in a dataset

`stat_sum_var`: provides summary statistics for a variable in a dataset chosen by user
